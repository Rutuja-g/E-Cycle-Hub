...
function loadOrders() {
  const storedOrders = localStorage.getItem("ecycle_orders");
...
function resolveOrder(id) {
  ...
  if (order) {
    ...
    localStorage.setItem("ecycle_orders", JSON.stringify(orders));
    displayOrders();
  }
}
...
function deleteOrder(id) {
  if (confirm("Are you sure you want to delete this order?")) {
    ...
    localStorage.setItem("ecycle_orders", JSON.stringify(filteredOrders));
    displayOrders();
  }
}

...
(function () {
  ...
  function renderCart() {
    ...
    const startShoppingBtn = createElement("a", "btn btn-secondary");
    startShoppingBtn.href = "shop.html";
    startShoppingBtn.textContent = "Start Shopping";
    startShoppingBtn.style.marginBottom = "1rem";
    startShoppingBtn.style.display = "inline-block";
    container.appendChild(startShoppingBtn);

// main.js - Loads product data and renders product cards
...
(function () {
  ...
  // Active nav link helper - disabled to make all nav links behave the same
  function setActiveNavLink() {
    // No active styling for consistency across all nav links
  }
  ...
  // Initialize UI helpers: nav toggle and footer year

...
(function () {
  ...
  function renderEmpty(container) {
    container.innerHTML =
      '<div class="empty"><p>Your cart is empty.</p><p><a href="products.html" class="btn ghost">Continue shopping</a></p></div>';
  ...
  function setupEvents() {
    ...
    checkoutBtn.addEventListener("click", function () {
      ...
      // In real app you'd call backend; here just clear and show success
      localStorage.removeItem(CART_KEY);
      renderCart();
      notify.textContent = "Order placed successfully. Thank you!";
